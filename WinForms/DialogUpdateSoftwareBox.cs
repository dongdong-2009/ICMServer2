...
namespace ICMServer
{
    public partial class DialogUpdateSoftwareBox : Form
    {
        ...
        public DialogUpdateSoftwareBox(string filePath, List<Device> Devices)
        {
            InitializeComponent();
            m_FilePath = filePath;
        ...
        private void DialogUpdateSoftwareBox_Load(object sender, EventArgs e)
        {
    ...
    class DataGridViewProgressCell : DataGridViewImageCell
    {
        ...
        public DataGridViewProgressCell() => this.ValueType = typeof(int);
