...
namespace ITE.WPF.Controls
{
    ...
    public class NumbericTextBox : TextBox
    {
        ...
        internal void TakeFocus(Direction direction, Selection selection)
        {
            this.Focus();
            ...
            {
                this.SelectionStart = (direction == Direction.Forward) ? 0 : this.Text.Length;
            }
        }

        internal void TakeFocus(Action action)
        {
            Focus();
